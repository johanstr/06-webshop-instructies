...
<form method="POST" action="src/formhandlers/registration_handler.php" class="uk-width-1-1 uk-flex uk-flex-center">
      ...
      <div class="uk-card-body uk-flex uk-flex-between uk-card-body-gap">
         <div class="uk-width-1-1 uk-flex uk-flex-column">
            <div class="">
               ...
               <input type="text" name="firstname" class="uk-input" id="firstname" placeholder="Voornaam..." required />
            ...
            <div class="uk-flex uk-gap uk-margin-top">
               ...
               <div class="uk-width-4-5">
                  ...
                  <input type="text" name="lastname" class="uk-input" id="lastname" placeholder="Achternaam..." required />
                  <!-- <p class="uk-text-danger uk-text-xsmall uk-text-italic uk-margin-remove-vertical">Bericht als dit veld niet ingevuld is</p> -->
               </div>
            </div>
            ...
            <div class="uk-flex uk-gap uk-margin-top">
               <div class="uk-width-3-5">
                  ...
                  <input type="text" name="street" class="uk-input" id="street" placeholder="Straatnaam..." required />
                  <!-- <p class="uk-text-danger uk-text-xsmall uk-text-italic uk-margin-remove-vertical">Bericht als dit veld niet ingevuld is</p> -->
               </div>
               <div class="uk-width-1-5">
                  ...
                  <input type="text" name="housenumber" class="uk-input" id="housenumber" placeholder="Huisnummer..." required />
                  <!-- <p class="uk-text-danger uk-text-xsmall uk-text-italic uk-margin-remove-vertical">Bericht als dit veld niet ingevuld is</p> -->
               </div>
               <div class="uk-width-1-5">
            ...
            <div class="uk-flex uk-gap uk-margin-top">
               <div class="uk-width-1-5">
                  ...
                  <input type="text" name="zipcode" class="uk-input" id="zipcode" placeholder="Postcode..." required />
                  <!-- <p class="uk-text-danger uk-text-xsmall uk-text-italic uk-margin-remove-vertical">Bericht als dit veld niet ingevuld is</p> -->
               </div>
               <div class="uk-width-4-5">
                  <label for="city" class="uk-form-label">Plaats<span class="uk-text-xsmall uk-text-italic uk-text-primary"> (Verplicht)</span></label>
                  <input type="text" name="city" class="uk-input" id="city" placeholder="Plaats..." required />
                  <!-- <p class="uk-text-danger uk-text-xsmall uk-text-italic uk-margin-remove-vertical">Bericht als dit veld niet ingevuld is</p> -->
               </div>
            </div>
            <div class="uk-margin-top">
               ...
               <input type="email" name="email" class="uk-input" id="email" placeholder="E-mail adres..." required />
               <!-- <p class="uk-text-danger uk-text-xsmall uk-text-italic uk-margin-remove-vertical">Bericht als dit veld niet ingevuld is</p> -->
            </div>
            <div class="uk-margin-top">
               ...
               <input type="password" name="password" class="uk-input" id="password" placeholder="Wachtwoord..." required />
               <!-- <p class="uk-text-danger uk-text-xsmall uk-text-italic uk-margin-remove-vertical">Bericht als dit veld niet ingevuld is</p> -->
            </div>
            <div class="uk-margin-top">
               ...
               <input type="password" name="password_confirm" class="uk-input" id="password-confirm" placeholder="Voer het wachtwoord nog eens in ter controle..." required />
